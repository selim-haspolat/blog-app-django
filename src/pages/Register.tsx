    ...
    <div className="flex justify-center items-center h-[calc(100vh-64px)]">
      <div className="w-full md:w-[70%] lg:w-[90%] max-w-[1200px] mx-auto bg-blue-500 h-full md:h-[100%] lg:h-[70%] p-3 flex justify-center items-center flex-col-reverse lg:flex-row gap-10 lg:gap-20">
        ...
        <div className="flex flex-col gap-7 justify-center items-center ">
          <div className="relative w-16 h-16 border-2 border-white overflow-hidden rounded-full">
            <svg
          ...
          >
            {({ values, handleBlur, handleChange, errors, touched }) => (
              <Form className="flex flex-col gap-5 w-96">
                ...
                <button
                  type="submit"
                  className="bg-white w-40 py-1.5 font-bold text-blue-500 self-center hover:bg-gray-200 transition-colors"
                >
                  Register
                </button>
              </Form>
